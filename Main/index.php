...
<html>
    ...
    <body>
        <nav class="navbar navbar-light nav-bar-custom" style="background-color: #193498; opacity: 0.85;" id="navbar">
            ...
            <a href="..\Function_Method\login.php">
                <i class="fas fa-cart-arrow-down fa-3x" style="color: #69DADB;"></i> 
            </a>
        </nav>
        <main>
            <div class="container">
                                    ...
                                    echo "
                                        <div class='col'>
                                            <div class='card' style='width: 18rem;'>
                                                ...
                                                <a href='..\Function_Method\login.php' style='padding-left: 110px;'><i class='fas fa-cart-plus fa-2x'></i></a>
                                                </div>
                                            </div>
                                        </div> 
                                    ";
                ...
                <p> <i class="fas fa-check-double" style="color: #0f0;"></i> <strong>Thời gian</strong> - Deli Food cung cấp dịch vụ giao đồ ăn, thức uống nhanh nhất thị trường, tiết kiệm thời gian.</p>
                <p> <i class="fas fa-check-double" style="color: #0f0;"></i> <strong>Thuận tiện</strong> - Giờ đây, chỉ với chiếc Smart Phone trên tay và với vài thao tác chạm nhẹ là bạn có thể đặt đồ ăn và thức uống một cách thuận tiện.</p>
                <p> <i class="fas fa-check-double" style="color: #0f0;"></i> <strong>Đáp ứng mọi nhu cầu</strong> - Với menu cực kì đa dạng giúp cho bạn cho những trải nghiệm mới mẻ tha hồ lựa chọn các món ăn phù hợp với khẩu vị của mình.</p>
                <p> <i class="fas fa-check-double" style="color: #0f0;"></i> <strong>Thanh toán dễ dàng</strong> - Thanh toán cực kì dễ dàng qua các sàn thương mại điện tử hoặc e-banking.</p>
                <p> <i class="fas fa-check-double" style="color: #0f0;"></i> <strong>Voucher</strong> - Cung cấp, cập nhật voucher thường xuyên, tích điểm mua sắm để sử dụng đổi lấy nhiều ưu đãi.</p>
                <br><br><br>
                <section id="questions">
                    ...
                    <article>
                        ...
                        <ol>
                            <li><strong>Tìm kiếm nhà hàng hoặc món yêu thích</strong> - Nhập địa chỉ của bạn tại trang chủ. Xem các Nhà hàng và điểm ăn uống gần chỗ bạn trong danh sách của Deli Food. Chọn nhà hàng bạn yêu thích, duyệt qua thực đơn và chọn món bạn muốn đặt.</li>
                            <li><strong>Kiểm tra & thanh toán</strong> - Sau khi chắc chắn bạn đã đặt đầy đủ các món theo nhu cầu. Hãy nhấn nút "ORDER NOW" trong giỏ hàng và nhập địa chỉ giao đồ ăn cuối cùng. Chọn phương thức thanh toán và voucher (nếu có) phù hợp và tiện lợi nhất đối với bạn.</li>
                            <li><Strong>Giao hàng</Strong> - Deli Food có thuật toán thiết kế để giảm thiểu tối thiểu chi phí, quãng đường vận chuyển. Việc của bạn sau khi hoàn thành đặt hàng là giữ điện thoại bên mình để nhận tin nhắn hay cuộc gọi khi bên vận chuyển đến giao.</li>
                        </ol>
                    </article>
                    <hr>
                    <article>
                        <h3>Deli Food là gì?</h3>
                        <p>Có thể nói Deli Food là một dịch vụ Giao đồ ăn nhanh nhất tại Việt Nam. Chúng tôi dựa vào những đơn hàng bạn đã thưởng thức để sắp xếp và đề xuất những thực phẩm yêu thích của bạn để bạn có thể tìm được đồ ăn một cách dễ dàng và hợp lí nhất. Ngoài ra chúng tôi còn hợp tác với nhiều đối tác cung cấp đồ ăn lơn để cho thuê các dịch vụ nhà hàng, đám cưới, đám hỏi, sinh nhật, ... nhằm phục vụ và cho khách hàng trải nghiệm những điều tốt nhất chỉ có ở chúng tôi.</p>
                    </article>
                    <hr>
                    <article>
                        <h3>Deli Food có nhận thanh toán bằng tiền mặt không?</h3>
                        <p>Tất nhiên là Deli Food chấp nhận mọi hình thức thanh toán cho dịch vụ đồ ăn, bao gồm cả tiền mặt giúp cho khách hàng có những trải nghiệm tuyệt vời.</p>
                    </article>
                    <hr>
                    <article>
                        <h3>Tôi có thể đặt đồ ăn cho người khác trên Deli Food được không?</h3>
                        <p>Tất nhiên rồi, Bạn chỉ cần cập nhật đúng địa chỉ người mình muốn gửi đồ ăn chính xác trước khi đặt đơn hàng của bạn. Còn lại hãy chứ để Deli Food chăm lo người thân của bạn.</p>
                    </article>
                    <hr>
                    <article>
                        <h3>Deli Food chi phí vận chuyển như thế nào?</h3>
                        <p>Phí giao hàng của chúng tôi phụ thuộc vào nhiều yếu tố hoạt động như khoảng cách từ vị trí của bạn đến nhà hàng. Bạn có thể kiểm tra chính xác phí giao hàng trước khi xác thực đơn hàng. Ngoài ra, chúng tôi còn liệt kê, đề xuất những nhà hàng gần nhà bạn để bạn có thể thoải mái mua sắm mà không lo lắng về phí giao hàng.</p>
                    </article>
                    <hr>
                    <article>
                        <h3>Deli Food có dịch vụ giao đồ ăn vào ban đêm không?</h3>  
                        <p>Nếu có điều gì đó quan trọng đối với chúng tôi thì đó chính là trải nghiệm của khách hàng. Chúng tôi cung cấp dịch vụ giao đồ ăn 24x7 giúp bạn có thể xua tan cơn "thèm đồ ăn" bất cứ lúc nào.</p>
                    </article>
                </section>
            </div>
        </main>
        ...
        <footer>
            <div class="container">
                ...
                <ul id="support-list">
                    ...
                    <li>
                        <a href="contact_infor_for_guest.php">Thông tin liên hệ</a>
                    </li>
                    <li id="network">
